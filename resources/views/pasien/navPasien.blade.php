...
<div class="ui fixed menu" style="box-shadow: 0px 3px 3px 0 rgba(187,16,21,1);">
 <div class="ui container">
    ...
    <a class="item" href="{{url('pasien/resep')}}">Daftar Resep yang berlangsung</a>
    <a class="item" href="{{url('pasien/resep/finished')}}">Daftar Resep yang selesai</a>
    <a class="item" href="{{url('pasien/history')}}">Riwayat Penyakit</a>
